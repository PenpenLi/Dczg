...
{
	public static int mSpacingY = 0;	// add by xuzheng
	...
	static public Vector3 CalculatePrintedSize (string text, Font font, int size, FontStyle style, bool encoding)
	{
		...
		BetterList<Color32> cols)
	{
		...
		int x = 0;
		int y = 0;
		int lineHeight = size + mSpacingY;	// add by xuzheng

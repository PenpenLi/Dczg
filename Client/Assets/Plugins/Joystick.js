		...
		for(var i : int = 0;i < count; i++)
		{
			...
			{	
				...
				{	
					...
					position.x = Mathf.Clamp( ( touch.position.x - fingerDownPos.x ) / ( touchZone.width / 1.0 ), -1, 1 );
					position.y = Mathf.Clamp( ( touch.position.y - fingerDownPos.y ) / ( touchZone.height / 1.0 ), -1, 1 );
				}
				else
				{					

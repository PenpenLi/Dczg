...
// 		NgUtil.LogMessage("ToolMessage - " + msg);
	...
	public void ShowHierarchyObjectPopup(string scriptFilename, Object selObj)
	{
		if (scriptFilename != null)
		{
			...
			if (m_CurrentHierarchyPopup == null)
				m_CurrentHierarchyPopup	= UnityEngineInternal.APIUpdaterRuntimeServices.AddComponent(m_ToolPopupGameObject, "Assets/Script/Zhangwei/FXMaker/ToolScript/ToolScript/FxmPopupManager.cs (395,31)", scriptFilename) as FxmPopup;
			if (m_CurrentHierarchyPopup != null)
	...
	// ShowModalOkCancelMessage啊 false 老锭父 荤侩
